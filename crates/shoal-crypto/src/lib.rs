//! # shoal-crypto — zero-dependency cryptographic primitives
//!
//! Every primitive Shoal needs, implemented from the primary specifications
...
//! `ciphra-crypto` does not export the modules Shoal needs (`x25519`,
//! `ml_kem`) and this build environment blocks the crates.io registry.
//!
//! | Module | Primitive | Spec | Shoal use |
//! |---|---|---|---|
...
//! | [`sha256`] | SHA-256 | FIPS 180-4 | Shoal IDs, KDF |
