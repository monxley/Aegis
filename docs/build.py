...
LANGS = {
    "en": {
        ...
        "shots": [("chats.jpg", "The Shoal conversation list on Android"),
                  ("contacts.jpg", "The Shoal contact list, each entry showing its Shoal ID"),
                  ("lock.jpg", "The Shoal lock screen: password, biometrics, hold to wipe"),
                  ("settings.jpg", "Shoal settings: share code, security, privacy, network"),
                  ("add-contact.jpg", "Adding a Shoal contact by pasting their share code"),
    ...
    "ru": {
        ...
        "shots": [("chats.jpg", "Список переписок Shoal на Android"),
                  ("contacts.jpg", "Список контактов Shoal, у каждого показан его Shoal ID"),
                  ("lock.jpg", "Экран блокировки Shoal: пароль, биометрия, удержание для стирания"),
                  ("settings.jpg", "Настройки Shoal: код для обмена, безопасность, приватность, сеть"),
                  ("add-contact.jpg", "Добавление контакта Shoal вставкой его кода"),
